...
namespace STransformNUnit {
    public class TerraNovaTests {
        ...
        public void testBase() {
            ...
            SuncorProductionFile ms = new TerraNovaParser().LoadFile(File.ReadAllText(ROOTDIR + "OIL-STORAGE-CORR-LD_Raw.csv"), "EP01", new DateTime(2019, 10, 03));
        ...
        public void test10dayPivot1() {
            SuncorProductionFile ms = new TerraNovaParser().LoadFile(File.ReadAllText(ROOTDIR + "OIL-STORAGE-CORR-LD_Raw.csv"), "EP01", new DateTime(2019, 11, 01));
        ...
        public void test10daytest() {
            SuncorProductionFile ms = new TerraNovaParser().LoadFile(File.ReadAllText(ROOTDIR + "OIL-STORAGE-CORR-LD_Raw.csv"), "EP01", new DateTime(2019, 10, 19));
        ...
        public void test10dayPivot2() {
            SuncorProductionFile ms = new TerraNovaParser().LoadFile(File.ReadAllText(ROOTDIR + "OIL-STORAGE-CORR-LD_Raw.csv"), "EP01", new DateTime(2019, 11, 11));  // after 10day pivot
        ...
        public void test10dayPivot4() {
            SuncorProductionFile ms = new TerraNovaParser().LoadFile(File.ReadAllText(ROOTDIR + "OIL-STORAGE-CORR-LD_Raw.csv"), "EP01", new DateTime(2019, 11, 9));  // before 10day pivot
            Assert.AreEqual(31, ms.GetTagBalanceRecords().Count);
