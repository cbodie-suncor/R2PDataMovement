...
namespace R2PTransformation.Models {
    ...
    public class DBContextWithConnectionString : AzureContext {
        ...
        public static void AddTestData(AzureContext context) {
            ...
            context.TagMap.Add(new TagMap { Tag = "RBOB2", Plant = "CP03", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "170552311a" });
            context.TagMap.Add(new TagMap { Tag = "RBOB3", Plant = "CP03", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "170552311b" });
            context.TagMap.Add(new TagMap { Tag = "RBOB4", Plant = "CP04", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "000000000000010422" });
            ...
            context.TagMap.Add(new TagMap { Tag = "RBOB6", Plant = "CN42", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "10422" });
            context.TagMap.Add(new TagMap { Tag = "RBOB7", Plant = "CP04", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "10422" });

            context.TagMap.Add(new TagMap { Tag = "RBOB8", Plant = "CP03", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "10072a" });
            context.TagMap.Add(new TagMap { Tag = "RBOB9", Plant = "CN42", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "49000109071" });
            context.TagMap.Add(new TagMap { Tag = "RBOB10", Plant = "CP03", Type = "Prod", DefaultValuationType = "SUNCOR", MaterialNumber = "10776" });
